package com.daou.supplier.util;
/******************************************************
...
import com.daou.supplier.model.CAEnrollment;
...
public class Util {
     ...
     * @throws Exception
     */
    public static void writeUserContext(BlockchainUser userContext) throws Exception {
     ...
     * @throws Exception
     */
    public static BlockchainUser readUserContext(String affiliation, String username) throws Exception {
        ...
        if (file.exists()) {
            ...
            BlockchainUser uContext = (BlockchainUser) in.readObject();
