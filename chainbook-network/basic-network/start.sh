...
docker exec -e "CORE_PEER_LOCALMSPID=Org2MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org2.chainbooks.com/msp" peer0.org2.chainbooks.com sh -c "peer channel fetch newest -o orderer.chainbooks.com:7050 -c mychannel && peer channel join -b mychannel_newest.block"
